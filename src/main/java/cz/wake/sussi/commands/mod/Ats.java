...
public class Ats implements ICommand {
    ...
    public void onCommand(User sender, MessageChannel channel, Message message, String[] args, Member member, EventWaiter w) {
        if (args.length < 1) {
            ...
            long survival_posledni_aktivita = Sussi.getInstance().getSql().getStalkerStatsTime(name, "surv_pos_aktivita") + opravnyCas;
            ...
            long skyblock_posledni_aktivita = Sussi.getInstance().getSql().getStalkerStatsTime(name, "sky_pos_aktivita")+ opravnyCas;
            ...
            long creative_posledni_aktivita = Sussi.getInstance().getSql().getStalkerStatsTime(name, "crea_pos_aktivita")+ opravnyCas;
            ...
            long prison_posledni_aktivita = Sussi.getInstance().getSql().getStalkerStatsTime(name, "prison_pos_aktivita")+ opravnyCas;
            ...
            long vanilla_posledni_aktivita = Sussi.getInstance().getSql().getStalkerStatsTime(name, "vanilla_pos_aktivita")+ opravnyCas;
            ...
            long minigames_posledni_aktivita = Sussi.getInstance().getSql().getStalkerStatsTime(name, "minigames_pos_aktivita")+ opravnyCas;
            ...
            long vanillasb_posledni_aktivita = Sussi.getInstance().getSql().getStalkerStatsTime(name, "vanillasb_pos_aktivita")+ opravnyCas;
